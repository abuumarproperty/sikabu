...
<body>
    ...
    <div class="container">
        <div class="header">
            ...
            <div class="center">
                <p>LAPORAN PEMBAYARAN ANGSURAN TANAH PERUMAHAN (KAVLING)</p>
                <h2>KANTOR PELAYANAN KOTA {{ $kantor_pelayanan }}</h2>
                <p>{{ $alamat }}</p>
            </div>
        </div>
        ...
        <div class="table-center">
            ...
            <table cellspacing="0" border="1">
                ...
                <tr class="table-footer" style="background-color: rgb(214, 250, 13);">
                    ...
                    <td colspan="6">Rp. {{ number_format($all_data->sum('nominal'), 0, ',', '.') }}</td>
                </tr>
