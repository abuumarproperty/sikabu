...
@section('content')
    @if (Auth::user()->is_admin == 0)
        <h1 class="app-page-title">Tambah Data Lahan</h1>
    @else
        <h1 class="app-page-title text-white">Tambah Data Lahan</h1>
    @endif
        ...
        <div class="col-12 col-md-10">
            ...
            <div class="app-card app-card-settings shadow-sm p-4">
                <div class="app-card-body">
                    <form action="/dashboard/lands" method="post" class="settings-form">
                        @csrf
