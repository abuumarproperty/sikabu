...
<body>
    ...
    <div class="container">
        ...
        <div class="table-center">
            ...
            <p>
                Tahun : <i>
                    {{ \Carbon\Carbon::parse(\Carbon\Carbon::now())->translatedFormat('Y') }}
                </i>
            </p>
            ...
            <table cellspacing="0" border="1">
                ...
                <tr class="table-footer" style="background-color: rgb(214, 250, 13);">
                    ...
                    <td colspan="2">Rp. {{ number_format($costumers->sum('besar_angsuran') * 12, 0, ',', '.') }}
                    </td>
                    <td colspan="7">Rp. {{ number_format($all_data->sum('nominal'), 0, ',', '.') }}</td>
                </tr>

                <tr class="table-footer" style="background-color: rgb(32, 241, 32);">
                    <td colspan="8">Total Penerimaan Tahun Ini</td>
                    <td colspan="7">Rp. {{ number_format($all_data->sum('nominal'), 0, ',', '.') }}</td>
                </tr>

                <tr class="table-footer" style="background-color: rgb(247, 69, 69);">
                    <td colspan="8">Total Tunggakan Tahun Ini</td>
                    <td colspan="7">Rp.
                        {{ number_format($costumers->sum('besar_angsuran') * 12 - $all_data->sum('nominal'), 0, ',', '.') }}
                    </td>
                </tr>
