...
@section('content')
    @if (Auth::user()->is_admin == 0)
        <h1 class="app-page-title">Form Batal atau Mundur</h1>
    @else
        <h1 class="app-page-title text-white">Form Batal atau Mundur</h1>
    @endif
        ...
        <div class="col-12 col-md-10">
            ...
            <div class="app-card app-card-settings shadow-sm p-4">
                <div class="app-card-body">
                    <form action="/dashboard/cancels" method="post" class="settings-form" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('no_surat_pembatalan') is-invalid @enderror"
                                ...
                                name="no_surat_pembatalan" value="{{ old('no_surat_pembatalan') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('blok') is-invalid @enderror" id="blok"
                                placeholder="Masukan Nama Blok" name="blok" value="{{ old('blok') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('alasan_batal') is-invalid @enderror" id="alasan_batal"
                                placeholder="Masukkan Alasan Batal" name="alasan_batal">{{ old('alasan_batal') }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                                ...
                                name="jumlah_uang_yang_telah_disetor" value="{{ old('jumlah_uang_yang_telah_disetor') }}">
