        ...
        <div class="col-12 col-md-10">
            ...
            <div class="app-card app-card-settings shadow-sm p-4">
                <div class="app-card-body">
                    <form action="/dashboard/properties/{{ $property->id }}" method="post" class="settings-form"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="hidden" name="oldFoto" value="{{ $property->foto }}">

                            <input type="file" class="form-control @error('foto') is-invalid @enderror" id="foto"
                                name="foto" value="{{ old('foto', $property->foto) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('alamat') is-invalid @enderror" id="alamat"
                                placeholder="Masukkan Alamat Properti" name="alamat">{{ old('alamat', $property->alamat) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('kota') is-invalid @enderror" id="kota"
                                name="kota" value="{{ old('kota', $property->kota) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('harga') is-invalid @enderror" id="harga"
                                name="harga" value="{{ old('harga', $property->harga) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi"
                                placeholder="Masukkan deskripsi Properti" name="deskripsi">{{ old('deskripsi', $property->deskripsi) }}</textarea>
